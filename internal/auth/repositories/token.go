...
type TokenRepository interface {
	...
	// It returns ErrTokenNotFound if no token are found.
	GetByToken(ctx context.Context, refreshToken string) (*Token, error)
...
func (r *tokenRepository) GetById(ctx context.Context, id string) (*Token, error) {
...
func (r *tokenRepository) GetByToken(ctx context.Context, refreshToken string) (*Token, error) {
...
func (r *tokenRepository) Create(ctx context.Context, token *Token) (string, error) {
